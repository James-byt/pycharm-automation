...
def stream():
    ...
    rsi_list = talib.RSI(inputs["close"], timeperiod=6)
...
while trade < 5:
    ...
    while keep_trading:
        ...
        if buy_zone == 3 or sell_zone == 3:
            ...
            if buy_zone == 3:
                print("buy wall")
                print(API.buy_digital_spot(ACTIVES, money, action, duration))
                ...
                print("sell wall")
                print(API.buy_digital_spot(ACTIVES, money, "put", duration))
                #results = API.check_win_v3(id)
                print("sell")
               # print(results)
