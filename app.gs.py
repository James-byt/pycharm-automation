...
goal = "NZDUSD-OTC" # NZDUSD EURJPY AUDUSD
new_money = 10
...
while trade < 10:
    ...
    while keep_trading:
        ...
        if buy_zone == 3 or sell_zone == 3:
            ...
            if buy_zone == 3:
                print("buy wall")
                check,idp = API.buy_digital_spot(ACTIVES, money, "put", duration)
                results = API.check_win_v3(idp)
                print("sell")
                print(results)
                #time.sleep(300)
                ...
                print("sell wall")
                check,idc = API.buy_digital_spot(ACTIVES, money, action, duration)
                print("buy")
                results = API.check_win_v3(idc)
                print(results)
